...
def main() -> None:
    ...
    parser.add_argument("--numero", required=True, help="Número de documento (campo en el sitio)")
    parser.add_argument("-o", "--output", type=Path, default=None, help="Carpeta de salida del PDF")
    parser.add_argument(
        "--registro-csv", type=Path, default=None, help="Ruta CSV de auditoría de consultas"
    )
