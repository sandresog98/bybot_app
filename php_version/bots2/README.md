# Bots2 — Automatizacion de consultas (Linux)

Migracion de `bots/` a `bots2/` enfocada en Linux, con modulo `common/` compartido,
parsers de extraccion de datos y base de datos MySQL consolidada.
...
```bash
cd /opt/lampp/htdocs/projects/bybot_v1/bots2
...
## Diferencias con `bots/`

| Aspecto | `bots/` (original) | `bots2/` (migrado) |
|---------|--------------------|--------------------|
