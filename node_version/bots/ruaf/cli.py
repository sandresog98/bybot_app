...
def main() -> None:
    parser = argparse.ArgumentParser(description="RUAF — consulta de afiliacion con OCR de captcha")
    ...
    parser.add_argument("--save-captchas", action="store_true", help="Guardar imagenes de captcha")
